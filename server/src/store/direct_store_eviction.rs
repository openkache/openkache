...
use super::direct_store_io::{bucket_hash_index_for_bucket, schedule_eviction_read};
use super::direct_store_mutations::PendingKeyedMutation;
use super::direct_store_policy::{item_state_is_live_at, unix_time_ms};
use super::{
    EvictableLocation, EvictionExtent, EvictionWork, GenerationLocation, Kvkache, TableLocation,
    find_item_in_bucket, items, storage_operation_error,
};
...
impl Kvkache {
    ...
    pub(super) fn clean_eviction_bucket(
        &mut self,
        logical_sg_id: u32,
        now_ms: u64,
