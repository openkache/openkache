...
use super::direct_store_io::{direct_buffer_from_bytes, write_generation};
use super::{
...
impl Kvkache {
    ...
    pub(super) fn complete_flush(&mut self, completion: FlushCompletion) -> Result<()> {
