//! Storage policy decisions shared by keyed mutation and capacity paths.
//!
...
pub(super) fn set_condition_allows(condition: StorageWriteCondition, current_live: bool) -> bool {
    match condition {
