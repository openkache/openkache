...
pub fn wire_codec_kind(
    name: &str,
) -> Option<crate::protocol::codec::CodecKind> {
    match name {
        "bool_u8" => Some(crate::protocol::codec::CodecKind::BoolU8),
        "enum" => Some(crate::protocol::codec::CodecKind::Enum),
        "f64_be" => Some(crate::protocol::codec::CodecKind::F64Be),
        "i32_be" => Some(crate::protocol::codec::CodecKind::I32Be),
        "list" => Some(crate::protocol::codec::CodecKind::List),
        "map" => Some(crate::protocol::codec::CodecKind::Map),
        "packed_f64_be" => Some(crate::protocol::codec::CodecKind::PackedF64Be),
        "raw_bytes" => Some(crate::protocol::codec::CodecKind::RawBytes),
        "u64_be" => Some(crate::protocol::codec::CodecKind::U64Be),
        "union" => Some(crate::protocol::codec::CodecKind::Union),
        "utf8" => Some(crate::protocol::codec::CodecKind::Utf8),
        _ => None,
    }
}
