...
// Keep the server package self-contained. These snapshots are generated from
// the canonical protocol model in the repository and are included directly
// so crates.io and docs.rs builds do not need Bun or the Smithy CLI.
include!("contract_snapshot/wire_values.rs");
...
pub mod operation {
    ...
    include!("contract_snapshot/operation_contract.rs");
}
