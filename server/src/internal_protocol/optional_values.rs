...
use crate::internal_protocol::{ProtocolError, Result};
...
impl OptionalValueCodec {
    ...
    pub fn encoded_len(self, values: &[Option<&[u8]>]) -> Result<usize> {
        ...
        crate::internal_protocol::validate_value_length(total)?;
        Ok(total)
    }
    ...
    pub fn decode<'a, 'b>(
        ...
        crate::internal_protocol::validate_value_length(payload.len())?;
        ...
        for index in 0..value_count {
            ...
            crate::internal_protocol::validate_value_length(length)?;
            let end = cursor
                .checked_add(length)
                .ok_or(ProtocolError::FrameLengthOverflow)?;
            if end > payload.len() {
...
impl OptionalValuesEncoder {
    ...
    pub fn push(&mut self, value: Option<&[u8]>) -> Result<()> {
        ...
        let next_len = self
            ...
            .ok_or(ProtocolError::FrameLengthOverflow)?;
        crate::internal_protocol::validate_value_length(next_len)?;
        self.payload
