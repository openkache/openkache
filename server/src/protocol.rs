...
fn request_layout(opcode: Opcode) -> RequestLayout {
    match crate::contract::operation_contract(opcode).request_kind {
        crate::contract::OperationRequestKind::Empty => RequestLayout::Empty,
        crate::contract::OperationRequestKind::ApplicationValue => RequestLayout::ApplicationValue,
        crate::contract::OperationRequestKind::ScopedItem => {
            if crate::contract::operation_contract(opcode).request_value_count > 0 {
                RequestLayout::Set
            } else {
                RequestLayout::Item
            }
        }
        crate::contract::OperationRequestKind::ScopedNamespace => RequestLayout::Namespace,
        crate::contract::OperationRequestKind::NamespaceOpen => RequestLayout::NamespaceOpen,
        crate::contract::OperationRequestKind::NamespaceUpdatePolicy => {
            RequestLayout::NamespaceUpdatePolicy
        }
        crate::contract::OperationRequestKind::NamespaceDelete => RequestLayout::NamespaceDelete,
    }
}
