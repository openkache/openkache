...
pub(in crate::runtime) struct KeyedDescriptor {
    ...
    pub(in crate::runtime) prepare: fn(&mut Kvkache, StorageKey, StorageCommand) -> PreparedKeyedCommand,
    pub(in crate::runtime) collapse: fn(KeyedVisibleState, Vec<StorageCommand>) -> CollapsedLaneBatch,
...
impl StorageCommand {
    ...
    pub(in crate::runtime) fn belongs_to_collapse_group(&self, collapse_group: u8) -> bool {
        self.descriptor().collapse_group == collapse_group
    }

    pub(in crate::runtime) fn is_exclusive(&self) -> bool {
...
pub(in crate::runtime) fn replace_mutation_response(
