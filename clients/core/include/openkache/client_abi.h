...
typedef enum openkache_client_set_condition {
    ...
    OPENKACHE_CLIENT_SET_CONDITION_IF_ABSENT = OPENKACHE_SMITHY_FFI_SET_CONDITION_IF_ABSENT,
    OPENKACHE_CLIENT_SET_CONDITION_IF_PRESENT = OPENKACHE_SMITHY_FFI_SET_CONDITION_IF_PRESENT,
