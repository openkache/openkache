...
typedef enum openkache_client_result_kind {
    OPENKACHE_CLIENT_RESULT_ERROR = 0,
    OPENKACHE_CLIENT_RESULT_OK = 1,
    OPENKACHE_CLIENT_RESULT_VALUE = 2,
    OPENKACHE_CLIENT_RESULT_NOT_FOUND = 3,
    OPENKACHE_CLIENT_RESULT_CREATED = 4,
    OPENKACHE_CLIENT_RESULT_REPLACED = 5,
    OPENKACHE_CLIENT_RESULT_DELETED = 6,
    OPENKACHE_CLIENT_RESULT_NOT_DELETED = 7,
    OPENKACHE_CLIENT_RESULT_CONNECTED = 8,
    OPENKACHE_CLIENT_RESULT_NOT_STORED = 9,
...
typedef enum openkache_client_connection_state {
    OPENKACHE_CLIENT_CONNECTION_CONNECTED = 0u,
    OPENKACHE_CLIENT_CONNECTION_RECONNECTING = 1u,
    OPENKACHE_CLIENT_CONNECTION_DISCONNECTED = 2u,
    OPENKACHE_CLIENT_CONNECTION_CLOSED = 3u,
    OPENKACHE_CLIENT_CONNECTION_UNKNOWN = 4u,
} openkache_client_connection_state_t;

typedef enum openkache_client_set_condition {
    OPENKACHE_CLIENT_SET_CONDITION_NONE = 0,
    OPENKACHE_CLIENT_SET_CONDITION_IF_ABSENT = 1,
    OPENKACHE_CLIENT_SET_CONDITION_IF_PRESENT = 2,
