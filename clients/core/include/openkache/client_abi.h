...
typedef enum openkache_client_result_kind {
    ...
    OPENKACHE_CLIENT_RESULT_STATE = OPENKACHE_SMITHY_FFI_RESULT_STATE,
...
typedef enum openkache_client_operation {
    ...
    OPENKACHE_CLIENT_OPERATION_RECONNECT = OPENKACHE_SMITHY_FFI_OPERATION_RECONNECT,
    /* Language-adapter operations; these are not wire opcodes. */
    OPENKACHE_CLIENT_OPERATION_GET_JSON = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_GET_JSON,
    OPENKACHE_CLIENT_OPERATION_SET_JSON = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_SET_JSON,
    OPENKACHE_CLIENT_OPERATION_ADAPTER_RECONNECT =
        OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_RECONNECT,
    OPENKACHE_CLIENT_OPERATION_STATE = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_STATE,
    OPENKACHE_CLIENT_OPERATION_RAW_GET = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_RAW_GET,
    OPENKACHE_CLIENT_OPERATION_RAW_SET = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_RAW_SET,
    OPENKACHE_CLIENT_OPERATION_RAW_DELETE = OPENKACHE_SMITHY_FFI_ADAPTER_OPERATION_RAW_DELETE,
