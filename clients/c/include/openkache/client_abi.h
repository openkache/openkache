...
enum {
  ...
  OPENKACHE_CLIENT_RESULT_UNKNOWN_MUTATION = 12u,
};

enum {
  OPENKACHE_CLIENT_STATUS_SUCCESS = 0u,
  OPENKACHE_CLIENT_STATUS_NOT_FOUND = 1u,
  OPENKACHE_CLIENT_STATUS_MUTATION = 2u,
  OPENKACHE_CLIENT_STATUS_ERROR = 3u,
  OPENKACHE_CLIENT_STATUS_UNKNOWN_MUTATION = 5u,
};

enum {
  OPENKACHE_CLIENT_ERROR_NONE = 0u,
  OPENKACHE_CLIENT_ERROR_INVALID_INPUT = 1u,
  OPENKACHE_CLIENT_ERROR_CONFIGURATION = 2u,
  OPENKACHE_CLIENT_ERROR_TIMEOUT = 3u,
  OPENKACHE_CLIENT_ERROR_TRANSPORT = 4u,
  OPENKACHE_CLIENT_ERROR_SERVER = 5u,
  OPENKACHE_CLIENT_ERROR_PROTOCOL = 6u,
  OPENKACHE_CLIENT_ERROR_VALUE = 7u,
  OPENKACHE_CLIENT_ERROR_KEY = 8u,
  OPENKACHE_CLIENT_ERROR_UNKNOWN_MUTATION = 10u,
  OPENKACHE_CLIENT_ERROR_CLOSED = 12u,
  OPENKACHE_CLIENT_ERROR_INTERNAL = 13u,
};

enum {
  OPENKACHE_CLIENT_KEY_TEXT = 0u,
  OPENKACHE_CLIENT_KEY_BYTES = 1u,
  OPENKACHE_CLIENT_KEY_INTEGER = 2u,
};
