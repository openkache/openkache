...
|---|---|---|
| Shared core | [`core/`](core/) | Protocol v1 raw and protected engine; previous value-format implementation pending v1 design migration |
...
| TypeScript / JavaScript | [`typescript/`](typescript/) | Protocol v1 Node-API SDK; current package still exposes the previous JSON compatibility surface while the v1 codec contract is migrated |
