...
pub fn wire_codec_kind(
    ...
    match name {
        "bool_u8" => Some(crate::internal_protocol::codec::CodecKind::BoolU8),
        "enum" => Some(crate::internal_protocol::codec::CodecKind::Enum),
        "f64_be" => Some(crate::internal_protocol::codec::CodecKind::F64Be),
        "i32_be" => Some(crate::internal_protocol::codec::CodecKind::I32Be),
        "list" => Some(crate::internal_protocol::codec::CodecKind::List),
        "map" => Some(crate::internal_protocol::codec::CodecKind::Map),
        "packed_f64_be" => Some(crate::internal_protocol::codec::CodecKind::PackedF64Be),
        "raw_bytes" => Some(crate::internal_protocol::codec::CodecKind::RawBytes),
        "u64_be" => Some(crate::internal_protocol::codec::CodecKind::U64Be),
        "union" => Some(crate::internal_protocol::codec::CodecKind::Union),
        "utf8" => Some(crate::internal_protocol::codec::CodecKind::Utf8),
        _ => None,
    }
}
