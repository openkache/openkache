...
use crate::internal_protocol::ITEM_ID_BYTES;
use crate::internal_value::{
...
use crate::internal_core::transport::RequestBudget;
use crate::internal_core::{
    DATA_PROTECTION_KEY_BYTES, DataProtectionKey, ItemId, ValueBytePermit as BytePermit,
};
...
/// stack growth.
pub const MAX_VALUE_DEPTH: usize = crate::internal_value::DEFAULT_MAX_DEPTH;
...
impl Default for ValueLimits {
    fn default() -> Self {
        Self {
            ...
            max_depth: crate::internal_value::DEFAULT_MAX_DEPTH,
            max_items: crate::internal_value::DEFAULT_MAX_ITEMS,
            max_integer_bytes: crate::internal_value::DEFAULT_MAX_INTEGER_BYTES,
...
pub enum Error {
    ...
    Structured(#[source] crate::internal_value::Error),
...
fn integer_to_binary64(integer: &crate::internal_value::Integer) -> Result<f64> {
