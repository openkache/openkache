...
use crate::internal_core::ValueKeyring;
use crate::internal_core::value::{Compression, Encryption, JsonValue, Value};
...
use crate::internal_core::{LocalRawClient, LocalRawClientBuilder};
#[cfg(feature = "quic-quinn")]
use crate::internal_core::{RawClient, RawClientBuilder};
#[cfg(feature = "tls-tcp")]
use crate::internal_core::{TlsTcpRawClient, TlsTcpRawClientBuilder};
use crate::internal_value::Value as StructuredValue;
...
macro_rules! protected_client_methods {
    ($raw:ty) => {
        ...
        async fn get_value_at_item_id(
            &self,
            namespace_id: u64,
            item_id: crate::internal_core::ItemId,
        ) -> Result<GetOutcome<Value>> {
            match self
                .raw
        ...
        pub fn request_budget(&self) -> crate::internal_core::RequestBudget {
            self.protection.request_budget()
        }

        /// Returns the configured value resource limits.
        pub fn value_limits(&self) -> crate::internal_core::value::ValueLimits {
