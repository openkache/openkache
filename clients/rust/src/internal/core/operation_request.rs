...
use crate::internal_protocol::request_fields::{
...
use crate::internal_core::request::{RequestBuilder, RequestContext};
...
impl RequestBuilder for OperationRequest {
    ...
    fn into_frame(self, request_id: u64) -> crate::internal_core::Result<OwnedRequestFrame> {
        ...
        {
            return Err(crate::internal_core::Error::protocol(
                crate::internal_protocol::ProtocolError::InvalidFieldSequence(
        ...
        .map_err(crate::internal_core::Error::protocol)
    }
}
...
fn validate_value_length(value_len: usize) -> Result<()> {
    if value_len > MAX_VALUE_BYTES {
        return Err(crate::internal_protocol::ProtocolError::ValueTooLarge {
            size: value_len,
