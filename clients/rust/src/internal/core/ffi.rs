...
//!
//! The ABI owns one completion-based runtime and one protected client per native handle. C, C++,
//! Python, and other native bindings only marshal buffers and interpret result discriminators;
//! connection management, retries, protocol framing, and value protection remain in this crate.
...
#[cfg(feature = "tls-tcp")]
use crate::internal_core::TlsTcpProtectedClient;
pub use crate::internal_core::contract::FFI_ABI_VERSION as ABI_VERSION;
pub use crate::internal_core::contract::FfiNamespaceDescriptor;
pub use crate::internal_core::contract::FfiOperationField;
pub use crate::internal_core::contract::{
...
use crate::internal_core::contract::{
    VALUE_FORMAT_ENCRYPTION_COMPACT, VALUE_FORMAT_ENCRYPTION_NONE, VALUE_FORMAT_ENCRYPTION_ROBUST,
};
use crate::internal_core::ffi_admission::{AdmissionState, FfiAdmission};
use crate::internal_core::transport::BytePermit;
use crate::internal_core::value::{
...
pub struct FfiClient {
    ...
    request_budget: crate::internal_core::RequestBudget,
...
impl FfiResult {
    ...
    fn from_error(error: crate::internal_core::Error) -> Self {
        let category = match &error {
            crate::internal_core::Error::Configuration { .. } => FfiErrorCategory::Configuration,
            crate::internal_core::Error::Connection(_)
            | crate::internal_core::Error::Runtime { .. } => FfiErrorCategory::Transport,
            crate::internal_core::Error::Timeout { .. } => FfiErrorCategory::Timeout,
            crate::internal_core::Error::Transport { .. } | crate::internal_core::Error::Io(_) => {
                FfiErrorCategory::Transport
            }
            crate::internal_core::Error::Server { code, .. } => {
                if matches!(
                    code.as_u8(),
                    value if value == crate::internal_protocol::Status::TooLarge as u8
                        || value == crate::internal_protocol::Status::Overloaded as u8
                        || value == crate::internal_protocol::Status::NoCapacity as u8
                ) {
            ...
            crate::internal_core::Error::UnexpectedResponse { .. }
            | crate::internal_core::Error::Protocol(_) => FfiErrorCategory::Protocol,
            crate::internal_core::Error::ResponseTooLarge { .. } => {
                FfiErrorCategory::ResourceExhausted
            }
            crate::internal_core::Error::ResourceLimit { .. } => {
                FfiErrorCategory::ResourceExhausted
            }
            crate::internal_core::Error::Tls(_) => FfiErrorCategory::Transport,
            crate::internal_core::Error::Value(_) => FfiErrorCategory::Value,
            crate::internal_core::Error::Key(_) => FfiErrorCategory::Key,
            crate::internal_core::Error::ClientClosed => FfiErrorCategory::Closed,
            crate::internal_core::Error::AmbiguousOutcome { .. } => {
...
impl FfiClient {
    ...
    fn request_budget(&self) -> crate::internal_core::RequestBudget {
...
fn run_worker(
    ...
    ready: SyncSender<std::result::Result<crate::internal_core::RequestBudget, String>>,
...
trait FfiRawClientApi {
    async fn ping(&self) -> crate::internal_core::Result<Duration>;
    async fn get(&self, item_id: ItemId) -> crate::internal_core::Result<GetOutcome<ItemValue>>;
    async fn set(
        &self,
        item_id: ItemId,
        value: ItemValue,
        options: SetOptions,
    ) -> crate::internal_core::Result<SetOutcome>;
    async fn delete(&self, item_id: ItemId) -> crate::internal_core::Result<DeleteOutcome>;
    async fn experimental_stats(&self) -> crate::internal_core::Result<String>;
    async fn experimental_sync(&self) -> crate::internal_core::Result<()>;
    async fn reconnect(&self) -> crate::internal_core::Result<()>;
    async fn get_in_namespace(
        &self,
        namespace_id: u64,
        item_id: ItemId,
    ) -> crate::internal_core::Result<GetOutcome<ItemValue>>;
    ...
    async fn delete_in_namespace(
        ...
        namespace_id: u64,
        item_id: ItemId,
    ) -> crate::internal_core::Result<DeleteOutcome>;
    async fn experimental_stats_in_namespace(
        &self,
        namespace_id: u64,
    ) -> crate::internal_core::Result<String>;
    async fn experimental_sync_in_namespace(
        &self,
        namespace_id: u64,
    ) -> crate::internal_core::Result<()>;
    async fn namespace_open_with_outcome(
        &self,
        name: Vec<u8>,
        create_if_missing: bool,
        policy: Option<NamespacePolicy>,
    ) -> crate::internal_core::Result<(crate::internal_core::NamespaceDescriptor, bool)>;
    async fn namespace_update_policy(
        &self,
        namespace_id: u64,
        expected_revision: u64,
        policy: NamespacePolicy,
    ) -> crate::internal_core::Result<crate::internal_core::NamespaceDescriptor>;
...
impl_ffi_raw_client!(crate::internal_core::LocalRawClient);
#[cfg(feature = "tls-tcp")]
impl_ffi_raw_client!(crate::internal_core::TlsTcpRawClient);
...
trait FfiProtectedClientApi: Clone + 'static {
    ...
    async fn get_canonical_key_unchecked(
        &self,
        canonical_key: &[u8],
    ) -> crate::internal_core::Result<GetOutcome<Value>>;
    async fn get_structured_canonical_key_cbor(
        &self,
        canonical_key: Vec<u8>,
    ) -> crate::internal_core::Result<GetOutcome<Vec<u8>>>;
    async fn get_json_canonical_key_unchecked(
        &self,
        canonical_key: &[u8],
    ) -> crate::internal_core::Result<GetOutcome<JsonValue>>;
...
#[cfg(feature = "quic-compio")]
impl_ffi_protected_client!(
    crate::internal_core::LocalProtectedClient,
    crate::internal_core::LocalRawClient
);
#[cfg(feature = "tls-tcp")]
impl_ffi_protected_client!(
    crate::internal_core::TlsTcpProtectedClient,
    crate::internal_core::TlsTcpRawClient
);
    ...
    while !shutdown.load(Ordering::Acquire) {
        ...
        match command {
            ...
            Command::ExecuteScoped {
                ...
                .unwrap_or_else(|_| {
                    Err(crate::internal_core::Error::configuration(
                        "operation",
...
async fn execute_structured(
    ...
    let result = match operation {
        ...
        FfiOperation::Set => client
            ...
            .await
            .map(set_result),
        _ => Err(crate::internal_core::Error::configuration(
            "operation",
...
) -> std::result::Result<FfiResult, crate::internal_core::Error> {
    match outcome {
    ...
    match operation {
        ...
        FfiOperation::SetJson => {
            ...
            let (json, _json_permits) =
                crate::internal_core::value::parse_json_input_with_budget(&value, limits, &budget)?;
            client
...
async fn namespace_open(
        ...
        .await
    {
        Ok((descriptor, created)) => match ffi_namespace_descriptor(descriptor) {
            ...
            Err(error) => FfiResult::from_error(crate::internal_core::Error::configuration(
...
fn set_options_from_flags(flags: u8, ttl_ms: u64) -> std::result::Result<SetOptions, String> {
    ...
    crate::internal_core::protocol::SetWireOptions::from_wire_parts(flags, ttl_ms)
...
fn ffi_namespace_descriptor(
    descriptor: crate::internal_core::NamespaceDescriptor,
...
pub fn json_result(
    ...
    budget: crate::internal_core::RequestBudget,
    limits: ValueLimits,
) -> std::result::Result<FfiResult, crate::internal_core::Error> {
    match outcome {
        ...
        GetOutcome::Found(Value::Raw(_)) => {
            Err(crate::internal_core::value::Error::ExpectedRawValue.into())
        }
        GetOutcome::NotFound => Ok(not_found_result()),
    }
}
...
) -> std::result::Result<(), crate::internal_core::value::Error> {
    match value {
        JsonValue::Null | JsonValue::Boolean(_) | JsonValue::Number(_) | JsonValue::String(_) => {
            serde_json_canonicalizer::to_writer(value, writer).map_err(|error| {
                writer.take_failure().unwrap_or_else(|| {
                    crate::internal_core::value::Error::InvalidJson(error.to_string())
                })
            })
        }
        JsonValue::Array(values) => {
            if depth >= limits.max_depth {
                return Err(crate::internal_core::value::Error::ResourceLimit {
...
struct BudgetJsonWriter<'a> {
    budget: &'a crate::internal_core::RequestBudget,
    limits: ValueLimits,
    payload: Vec<u8>,
    permits: Vec<BytePermit>,
    written: usize,
    failure: Option<crate::internal_core::value::Error>,
}

impl<'a> BudgetJsonWriter<'a> {
    fn new(budget: &'a crate::internal_core::RequestBudget, limits: ValueLimits) -> Self {
        Self {
            budget,
            limits,
            payload: Vec::new(),
    ...
    fn take_failure(&mut self) -> Option<crate::internal_core::value::Error> {
        self.failure.take()
    }

    fn fail(&mut self, error: crate::internal_core::value::Error) -> io::Error {
...
impl Write for BudgetJsonWriter<'_> {
    fn write(&mut self, bytes: &[u8]) -> io::Result<usize> {
        let next = self.written.checked_add(bytes.len()).ok_or_else(|| {
            self.fail(crate::internal_core::value::Error::ResourceLimit {
        ...
        let permit = crate::internal_core::value::reserve_budget(
            self.budget,
            bytes.len(),
            &self.limits,
        ...
        self.payload.try_reserve_exact(bytes.len()).map_err(|_| {
            self.fail(crate::internal_core::value::Error::Allocation { size: bytes.len() })
        })?;
...
fn connect_options_with_keyring(
    ...
    let max_in_flight = if base.max_in_flight == 0 {
        crate::internal_core::DEFAULT_MAX_IN_FLIGHT
    } else {
        base.max_in_flight
    };
    FfiClient::connect(
...
pub unsafe extern "C" fn openkache_client_execute_scoped(
    ...
    boxed_result(catch_result(|| {
        ...
        match operation {
            ...
            | FfiOperation::SetV0
            | FfiOperation::Delete
                if item_id.len() > crate::internal_core::MAX_ITEM_ID_BYTES =>
            {
                Err(format!(
                    "item_id must contain at most {} bytes, got {}",
                    crate::internal_core::MAX_ITEM_ID_BYTES,
                    item_id.len()
                ))
            }
            FfiOperation::Get
...
pub unsafe extern "C" fn openkache_client_namespace_open(
    ...
    boxed_result(catch_result(|| {
        ...
        if name.len() > crate::internal_protocol::compat_v1::NAMESPACE_NAME_MAX_BYTES {
            return Err(format!(
                "namespace name exceeds {} octets",
                crate::internal_protocol::compat_v1::NAMESPACE_NAME_MAX_BYTES
            ));
        }
...
pub unsafe extern "C" fn openkache_client_namespace_descriptor_decode(
    ...
    let Ok(descriptor) = crate::internal_core::NamespaceDescriptor::decode(payload) else {
        return FFI_NAMESPACE_DESCRIPTOR_DECODE_INVALID;
    };
...
fn ffi_key_bytes(key_spec: u32, key: Vec<u8>, raw: bool) -> std::result::Result<Vec<u8>, String> {
    if raw {
        if key.len() > crate::internal_core::MAX_ITEM_ID_BYTES {
            return Err(format!(
                "item_id must contain at most {} bytes, got {}",
                crate::internal_core::MAX_ITEM_ID_BYTES,
                key.len()
...
fn execute_entry_inner(
    ...
    boxed_result(catch_result(|| {
        ...
        if raw
            ...
            && application_key.len() > crate::internal_core::MAX_ITEM_ID_BYTES
        {
            return Err(format!(
                "item_id must contain at most {} bytes, got {}",
                crate::internal_core::MAX_ITEM_ID_BYTES,
...
fn copy_fixed_value_key(
    pointer: *const u8,
    length: usize,
) -> std::result::Result<[u8; crate::internal_core::DATA_PROTECTION_KEY_BYTES], String> {
    let bytes = copy_bytes(pointer, length, "value key")?;
    bytes.try_into().map_err(|bytes: Vec<u8>| {
        format!(
            "value key must contain exactly {} bytes, got {}",
            crate::internal_core::DATA_PROTECTION_KEY_BYTES,
            bytes.len()
        )
    })
}
...
fn validate_input_lengths(
    ...
    if raw
        ...
        && application_key_length > crate::internal_core::MAX_ITEM_ID_BYTES
    {
        return Err(format!(
            "item_id must contain at most {} bytes, got {}",
            crate::internal_core::MAX_ITEM_ID_BYTES,
...
fn validate_scoped_input_lengths(
    ...
    if matches!(
        ...
        FfiOperation::Get
            ...
            | FfiOperation::SetV0
            | FfiOperation::Delete
    ) && item_id_length > crate::internal_core::MAX_ITEM_ID_BYTES
    {
        return Err(format!(
            "item_id must contain at most {} bytes, got {}",
            crate::internal_core::MAX_ITEM_ID_BYTES,
