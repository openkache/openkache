...
pub const MAGIC_AND_VERSION: [u8;
    crate::internal_core::contract::VALUE_ENVELOPE_MAGIC_AND_VERSION.len()] =
    crate::internal_core::contract::VALUE_ENVELOPE_MAGIC_AND_VERSION;

/// Maximum UTF-8 byte length of an encoding identifier.
pub const MAX_ENCODING_BYTES: usize =
    crate::internal_core::contract::VALUE_ENVELOPE_MAX_ENCODING_BYTES;

/// Maximum UTF-8 byte length of a logical type name.
pub const MAX_TYPE_NAME_BYTES: usize =
    crate::internal_core::contract::VALUE_ENVELOPE_MAX_TYPE_NAME_BYTES;
