...
use crate::internal_core::key::validate_canonical_key;
...
impl DataProtection {
    ...
    pub fn with_profile_and_key_type_and_format(
        key: ClientRootKey,
        key_type: crate::internal_core::KeyType,
        key_format: KeyFormat,
        compression: Compression,
        encryption: Encryption,
    ) -> Result<Self> {
        crate::internal_core::KeySpace::with_format(key_type, key_format)
            .validate()
    ...
    pub fn open_in_namespace(
        ...
        match self.decode_in_namespace(namespace_id, item_id, encoded)? {
            ...
            Value::Json(_) => Err(crate::internal_core::value::Error::ExpectedRawValue.into()),
        }
    }
