...
public class Client private constructor(
    ...
    override fun smithyInvokeScoped(
        ...
        if (requiredItemIdBytes != 0 && itemId.size > requiredItemIdBytes) {
            throw IllegalArgumentException("itemId must contain at most ${requiredItemIdBytes} bytes")
        }
    ...
    companion object {
        ...
        private fun readResult(
            ...
            try {
                ...
                val status = native.openkache_client_result_status(result)
                ...
                return NativeResult(kind, status, payload, client)
            } finally {
