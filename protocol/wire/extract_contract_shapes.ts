...
/**
 * Derives a flattened field plan for one operation input or output shape.
 *
 * The planner is transport-neutral: it follows Smithy shape references and
 * records codec metadata, while framing and compatibility semantics remain in
 * the caller-selected operation adapter.
 */
