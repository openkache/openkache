/** Client compatibility projections layered over the shared wire contract. */
...
/**
 * Preserves optional client metadata after generic wire extraction.
 *
 * Request framing is owned entirely by `requestWire`; this adapter neither
